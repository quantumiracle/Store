...
NUM_PINS = 91  #127
VS_DIM = 9 # dim of vector state
S_DIM_ALL =  S_DIM*S_DIM*CHANNEL
env_name = "./tac_push_random2"  # Name of the Unity environment binary to launch
    ...
    if args.test:
        ...
        for _ in range(test_episode):
            ...
            for t in range(test_steps):
                # env.render()
                a=GLOBAL_PPO.choose_action(s[:9])
                print(a)
